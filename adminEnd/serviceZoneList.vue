  ...
  <view class="service-zone-page">
    ...
    <view class="page-content">
      ...
      <view class="action-buttons">
        <button class="refresh-cache-btn" @click="refreshCache" :disabled="refreshLoading">
          <view class="btn-icon" :class="{ rotating: refreshLoading }">🔄</view>
          <text class="btn-text">{{ refreshLoading ? '刷新中...' : '刷新缓存' }}</text>
        </button>
      </view>
  ...
  methods: {
    ...
    async refreshCache() {
      ...
      try {
        ...
        const res = await this.$request('data/refreash/zone', params, 'POST');
