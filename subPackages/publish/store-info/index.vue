<template>
	<view class="store-info-page">
		...
		<view class="history-card">
			...
			<text class="button-tip">一键导入服务过门店详情，更省时！</text>
		</view>
					...
					<view class="input-row">
						...
						<view class="radio-container">
							<view class="radio-group">
								<view class="radio-item" @click="updateField('device_outside', true)">
									<view class="radio-circle" :class="{ 'radio-checked': formData.device_outside === true }">
										<view class="radio-inner" v-if="formData.device_outside === true"></view>
									</view>
									<text class="radio-text">外摆</text>
								</view>
								<view class="radio-item" @click="updateField('device_outside', false)">
									<view class="radio-circle" :class="{ 'radio-checked': formData.device_outside === false }">
										<view class="radio-inner" v-if="formData.device_outside === false"></view>
									</view>
						...
						<view class="input-container horizontal">
							<view class="input-wrapper">
								...
								<view class="placeholder-box" v-if="!formData.poiRemark">
									<text class="placeholder-text">点击填写门店POI备注</text>
								</view>
							</view>
						</view>
					</view>
